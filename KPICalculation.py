...
NumSimu=93 #Number of simulations that script must iterate
thresholdSPED = 0.25 # for defining how many links have the KPIs under the treshold
thresholdFLOW = 10 # for defining how many links have the KPI under the threshold
fd=5 #forecast distance in minutes
delta=10 #delta (width of TRE simulation interval, )
...
if ifCreateDedicatedFolder == 0:
    ...
    if ifflow > 0:
        whichKPI = 'KPI_Flow_t' + str(delta)
    else:
        whichKPI = 'KPI_Speed_t' + str(delta)
